                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" aria-label="Configuracion de mi cuenta">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ Auth::user()->surname }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" name="nick" value="{{ Auth::user()->nick }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="actions">
                                    ...
                                    <button type="button" class="btn btn-dark btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Subir imagen
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input type="file" id="image file-input" class="form-control @error('image') is-invalid @enderror">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                    <a href="" class="btn btn-dark">Guardar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-0" style="margin-left: 40%;">
